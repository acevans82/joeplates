...
export const cycleSteps: CycleStep[] = [
  {
    ...
    story: 'Where most Guests first meet Joe. A dinner becomes a memory, a memory becomes tradition.',
  ...
  },
  {
    ...
    story: 'Joe ventures to Bordeaux, Andalusia, or wherever the next story lives. Sometimes alone, sometimes with Members.',
    image: '/images/travel/vineyard-view.jpg',
    icon: 'travel',
  ...
  },
  {
    ...
    story: 'From those travels, bottles return. Rare finds that land in your cellar or on your table next season.',
  ...
  },
  {
    ...
    story: 'The rhythm continues. Guests become Members, collections grow, and the table gets set again.',
...
export const travelCalendar: MonthlyCalendar[] = [
  ...
  },
  {
    ...
    destinations: [
      ...
      {
        location: 'Stop in LA',
        blurb: 'Koreatown late nights, taco truck pilgrimages, and connecting with chef friends.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    destinations: [
      {
        location: 'Minnesota',
        blurb: 'Lake dinners at golden hour, fresh sweet corn, and stone fruit from the farmers\' markets.',
      },
    ],
  },
  {
